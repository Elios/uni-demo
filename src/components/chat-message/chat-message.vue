<template>
	<view class="m-item" :id="'message'+cid">
		<view class="m-left">
			<image class="head_icon" :src="message.uInfo.avatar" v-if="message.user=='home'"></image>
		</view>
		<view class="m-content">
			<view class="m-content-head" :class="{'m-content-head-right':message.user=='customer'}">
				<view :class="'m-content-head-uname-'+message.user" class="m-content-head-uname">
					{{message.uInfo.uname}}
				</view>
		...
		<view class="m-right">
			<image class="head_icon" :src="message.uInfo.avatar" v-if="message.user=='customer'"></image>
		</view>
	</view>
</template>
...
<style>
	...
	.m-content-head-uname{
		font-size: 25upx;
	}
	
	.m-content-head-uname-customer{
		position: absolute;
		right: 0upx;
		top: -35upx;
	}
	...
	.m-content-head-customer:after {
		border: 15upx solid transparent;
		border-left: 15upx solid #ffd9e6;
		top: 20upx;
		right: -26upx;
		width: 0;
		height: 0;
